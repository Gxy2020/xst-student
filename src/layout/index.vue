<template>
  <el-container>
    ...
    <el-footer height="140" class="student-footer">
<!--      <div class="container">-->
...
<!--        </div>-->
        <div class="do-align-center">
          <p class="footer-social-title">源码社区</p>
          <a href="https://github.com/Gxy2020" target="_blank"> <svg-icon icon-class="social-github" style="width: 32px;height: 32px;" /></a>
<!--          <a href="https://gitee.com/mindskip/uexam" target="_blank"><svg-icon icon-class="gitee" style="width: 32px;height: 32px;" /></a>-->
        </div>
<!--      </div>-->
    </el-footer>
    <div class="foot-copyright">
      <span>Copyright © 2020 软件1831第五组版权所有</span>
    </div>
  </el-container>
</template>
